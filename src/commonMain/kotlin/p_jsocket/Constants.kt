...
object Constants {
    ...
    var CLIENT_ANSWER_TYPE_POOLS_SIZE = 4000
    ...
    var RE_SEND_REQUEST_PROFILE_BY_TIMEOUT = 0

    //@JsName("TIME_OUT_RE_SEND_CASH_DATA")
    var TIME_OUT_RE_SEND_CASH_DATA = 2000L

    //@JsName("CLIENT_TIMEOUT_FOR_WAIT_ANSWER")
    var CLIENT_TIMEOUT_FOR_WAIT_ANSWER = 200000L

    //@JsName("MAX_MEDIA_FILES_SIZE_B_FOR_PLAY")
    var MAX_MEDIA_FILES_SIZE_B_FOR_PLAY = 2147480000
    ...
    fun initialise() {
        ...
        TIME_OUT_RE_SEND_CASH_DATA =  META_DATA["TIME_OUT_RE_SEND_CASH_DATA"]?:TIME_OUT_RE_SEND_CASH_DATA

        CLIENT_TIMEOUT_FOR_WAIT_ANSWER =  META_DATA["CLIENT_TIMEOUT_FOR_WAIT_ANSWER"]?:CLIENT_TIMEOUT_FOR_WAIT_ANSWER

        MAX_MEDIA_FILES_SIZE_B_FOR_PLAY = META_DATA["MAX_MEDIA_FILES_SIZE_B_FOR_PLAY"]?.toInt()?:MAX_MEDIA_FILES_SIZE_B_FOR_PLAY
