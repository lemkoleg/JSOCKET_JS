...
object Constants {
    ...
    var MAX_COUNT_OF_CASHDATA_BLOCKS_OF_LINKS: Int = 200

    @JsName("MAX_COUNT_OF_CASHDATA_BLOCKS_OF_OBJECT_INFO")
    var MAX_COUNT_OF_CASHDATA_BLOCKS_OF_OBJECT_INFO: Int = 500

    @JsName("MAX_COUNT_OF_CASHDATA_BLOCKS_OF_TEXT_LISTS")
    var MAX_COUNT_OF_CASHDATA_BLOCKS_OF_TEXT_LISTS: Int = 500

    @JsName("CALL_UPDATED_CASH_DATA_FOR_EACH_INCOMING_BLOCK")
    var CALL_UPDATED_CASH_DATA_FOR_EACH_INCOMING_BLOCK: Int = 500

    @JsName("MAX_COUNT_OF_CASHDATA_BLOCKS_OF_MESSEGES")
    var MAX_COUNT_OF_CASHDATA_BLOCKS_OF_MESSEGES: Int = 1000
