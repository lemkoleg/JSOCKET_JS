...
import lib_exceptions.exc_error_to_create_ANSWER_TYPE_Subscribe
...
class ANSWER_TYPE_Subscribe  constructor(
    fields_number: Int,
    @JsName("fields_name")
    ...
    val getFieldsValue: (ANSWER_TYPE) -> Any? = when(fields_number)
    { 
    ...
    @JsName("setFieldsValue")
    val setFieldsValue: (ANSWER_TYPE, Any?) -> Unit =  when(fields_number)
{
