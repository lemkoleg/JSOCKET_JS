...
expect class SQLStatement() {
    ...
    @JsName("TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_LINKS")
    suspend fun TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_LINKS()

    @JsName("TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_OBJECTS")
    suspend fun TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_OBJECTS()

    @JsName("TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_TEXT_LISTS")
    suspend fun TRIGGER_CASHLASTUPDATE_CONTROL_COUNT_TEXT_LISTS()
